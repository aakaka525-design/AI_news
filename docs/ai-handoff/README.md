...
| 评分产品化 | 综合评分 API/页面/交互落地讨论 | `composite-score-productization-proposal.md` |
| 数据源迁移 | 去 Tushare 依赖与自建/免费数据源迁移讨论 | `self-built-datasource-proposal.md` |
...
| `composite-score-productization-proposal.md` | Codex | 综合评分产品化提案 | 活跃 |
| `self-built-datasource-proposal.md` | Claude | 去 Tushare 依赖方案提案 | 活跃 |
